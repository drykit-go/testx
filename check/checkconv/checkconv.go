...
// Last generated on 24 Aug 21 10:35 UTC
...
// It can be used to facilitate checkers usage by test runners.
// It panics if checker is not a known checker type, e.g. a custom checker
// that implements check.IntChecker will be successfully converted, while
// a valid implementation of an unknown interface, such as Float64Checker,
// will panic.
// For that matter, Retrieve can be used instead.
