...
type (
	...
	// It returns a boolean that indicates whether the gotten any value
	// passes the current check.
	ValuePassFunc func(got any) bool
...
type (
	...
	// whether the gotten any value passes the current check.
	ValuePasser interface{ Pass(got any) bool }
