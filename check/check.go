...
// Last generated on 27 Aug 21 04:22 UTC
...
// Explain explains the reason of a failed check for the gotten value.
func (c valueChecker) Explain(label string, got interface{}) string { return c.explFunc(label, got) }

// NewValueChecker returns a custom ValueChecker with the provided ValuePassFunc
// and ExplainFunc.
func NewValueChecker(passFunc ValuePassFunc, explainFunc ExplainFunc) ValueChecker {
	return valueChecker{passFunc: passFunc, explFunc: explainFunc}
}
